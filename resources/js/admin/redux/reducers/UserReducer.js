...
const userReducer = function (state = initialState, action) {
    switch (action.type) {
        case UserActionTypes.SET_USER_DEFAULTS:
            return {
                ...state,
                user: {...state.user},
                success_message: "",
        ...
        case UserActionTypes.LIST_USERS_SUCCESS:
            return {
                ...state,
                users: action.data,
                list_spinner: false
            };
        case UserActionTypes.LIST_USERS_FAILURE:
            return {
                ...state,
        ...
        case UserActionTypes.CREATE_USERS_FAILURE:
            return {
                ...state,
                create_update_spinner: false,
        ...
        case UserActionTypes.SHOW_USER_SUCCESS:
            return {
                ...state,
                create_update_spinner: false,
                user: {...action.data.data, password: ""}
            };
        case UserActionTypes.SHOW_USER_FAILURE:
            return {
                ...state,
                create_update_spinner: false,
                error_message: action.error.message
        ...
        case UserActionTypes.EDIT_USERS_SUCCESS:
            return {
                ...state,
                create_update_spinner: false,
                user: action.data.data,
        ...
        case UserActionTypes.EDIT_USERS_FAILURE:
            return {
                ...state,
                create_update_spinner: false,
                error_message: action.error.message,
        ...
        case UserActionTypes.DELETE_USERS_FAILURE:
            return {
                ...state,
                list_spinner: false,
                error_message: action.error.message,
        ...
        case UserActionTypes.RESET_USER_FIELDS:
            return {
                ...state,
                user: {
                    id: "",
        ...
        case UserActionTypes.HANDLE_USER_CHANGE:
